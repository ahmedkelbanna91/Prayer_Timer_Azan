#include <Arduino.h>
#line 1 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
/*
...
int tday = 0, tmon = 0, tyear = 0, thr = 0, tmin = 0, tsec = 0;
...
char Date_hijri[20], Month_hijri[20], Day_hijri[20], Date_Gregorian[20], Month_Gregorian[20], Day_Gregorian[20], PrayerData[100];
bool got_time = false;
...
#line 137 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void debugPrint(const char *format, ...);
#line 146 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void debugging();
#line 166 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void setup();
#line 195 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void loop();
#line 260 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void checkPrayerTimes(int tim);
#line 294 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void fetchData(int day, int &month, int &year, const char *city, const char *country);
#line 431 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void configModeCallback(WiFiManager *myWiFiManager);
#line 438 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void esp_wifi_stp();
#line 469 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void esp_ota_stp();
#line 518 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
const char * formatBytes(size_t bytes);
#line 533 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
const char * listDir(const char *dirname, uint8_t levels, bool print);
#line 571 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void esp_wfm_stp();
#line 802 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void esp_mdns_stp();
#line 811 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void timeavailable(struct timeval *t);
#line 826 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void esp_ntp_stp();
#line 851 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void performUpdate(Stream &updateSource, size_t updateSize);
#line 880 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void esp_sd_ota_stp();
#line 908 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void esp_audio_stp();
#line 925 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void AudioVU();
#line 937 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void audio_eof_mp3(const char *info);
#line 941 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void playAudio(const char *filename, int volume);
#line 955 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void playSequence(int vol, int repeatCount);
#line 1011 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void esp_neo_stp();
#line 1016 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void SHOW_LED(int R, int G, int B, int W);
#line 1028 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void esp_sd_stp();
#line 1064 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void monitorMMCCard();
#line 137 "C:\\Users\\MSI-PC\\Desktop\\Esp32-Dev\\Prayer_Timer_Azan\\Prayer_Timer_Azan_sd\\Prayer_Timer_Azan_sd.ino"
void debugPrint(const char *format, ...) {
  va_list args;
...
void setup() {
  pinMode(MMC_DETECT, INPUT_PULLUP);
  ...
  if (!OTA) {
    ...
    if (millis() - lastTimeCheck >= 1000) {
      ...
      if (getLocalTime(&timeinfo)) {
        got_time = true;
        tday = timeinfo.tm_mday;          // day of month:  1–31
        tmon = timeinfo.tm_mon + 1;       // month:          1–12 (tm_mon is 0–11)
        tyear = timeinfo.tm_year + 1900;  // full year:     e.g. 2025
        thr = timeinfo.tm_hour;           // hours:          0–23
        tmin = timeinfo.tm_min;           // minutes:        0–59
        tsec = timeinfo.tm_sec;           // seconds:        0–60
      } else {
        got_time = false;
      ...
      if (!prayerTimesFetched) {
        fetchData(tday - 1, tmon, tyear, "Dusseldorf", "Germany");
        return;
      } else {
        static int lastRestartDay = -1;
        if (thr == 0 && tmin == 0 && tsec == 0 && lastRestartDay != tday) {
          lastRestartDay = tday;
          SHOW_LED(0, 0, 255, 0);
          fetchData(tday - 1, tmon, tyear, "Dusseldorf", "Germany");
          _PRINT_DEBUG_("✅   Daily fetch triggered at 00:00\n");
        }

        if (!audio.isRunning()) SHOW_LED(0, 5, 0, 0);
        checkPrayerTimes(thr * 60 + tmin);

        // debugging();

        _PRINT_DEBUG_("%02d:%02d:%02d  %02d.%02d.%04d   %s-%s-%s  %s-%s-%s  F%s D%s A%s M%s I%s\n%s\n",
                      thr, tmin, tsec,
                      tday, tmon, tyear,
                      Date_Gregorian, Month_Gregorian, Day_Gregorian,
                      Date_hijri, Month_hijri, Day_hijri,
                      Time_Fajr, Time_Dhuhr, Time_Asr, Time_Maghrib, Time_Isha,
                      PrayerData);
      }
    }
  }
...
void fetchData(int day, int &month, int &year, const char *city, const char *country) {
  ...
  filter["data"][0]["date"]["gregorian"]["month"]["en"] = true;
  filter["data"][0]["date"]["gregorian"]["weekday"]["en"] = true;
  filter["data"][0]["date"]["hijri"]["date"] = true;
  filter["data"][0]["date"]["hijri"]["month"]["ar"] = true;
  filter["data"][0]["date"]["hijri"]["weekday"]["ar"] = true;
  ...
  const char *m_gregorian = dataObject["date"]["gregorian"]["month"]["en"].as<const char *>();
  const char *wd_gregorian = dataObject["date"]["gregorian"]["weekday"]["en"].as<const char *>();

  const char *d_hijri = dataObject["date"]["hijri"]["date"].as<const char *>();
  const char *m_hijri = dataObject["date"]["hijri"]["month"]["ar"].as<const char *>();
  const char *wd_hijri = dataObject["date"]["hijri"]["weekday"]["ar"].as<const char *>();
  ...
  COPY_JSON_STRING(Month_Gregorian, m_gregorian);
  COPY_JSON_STRING(Day_Gregorian, wd_gregorian);
  COPY_JSON_STRING(Date_hijri, d_hijri);
  COPY_JSON_STRING(Month_hijri, m_hijri);
  COPY_JSON_STRING(Day_hijri, wd_hijri);

  prayerTimes[0] = { "Fajr", NVol - 4, time2Minutes(Time_Fajr) };
  prayerTimes[1] = { "Dhuhr", NVol, time2Minutes(Time_Dhuhr) };
  prayerTimes[2] = { "Asr", NVol, time2Minutes(Time_Asr) };
  prayerTimes[3] = { "Maghrib", NVol, time2Minutes(Time_Maghrib) };
  prayerTimes[4] = { "Isha", NVol - 2, time2Minutes(Time_Isha) };
...
const char *listDir(const char *dirname, uint8_t levels, bool print) {
  static char jsonRes[2048];  // Static buffer to hold the JSON response
  ...
  if (!root || !root.isDirectory()) {
    ...
    snprintf(jsonRes, sizeof(jsonRes), "{\"status\":\"error\",\"message\":\"Invalid directory\"}");
    return jsonRes;
  }

  strncpy(jsonRes, "[", sizeof(jsonRes));

  File file = root.openNextFile();
  while (file) {
    if (strlen(jsonRes) > 1) {
      strncat(jsonRes, ",", sizeof(jsonRes) - strlen(jsonRes) - 1);
    }
    ...
    strncat(jsonRes, entry, sizeof(jsonRes) - strlen(jsonRes) - 1);
...
void esp_wfm_stp() {
  server.on("/", HTTP_GET, [](AsyncWebServerRequest *request) {
    AsyncWebServerResponse *response = request->beginResponse(200, "text/html", (const uint8_t *)index_html, index_html_len);
  ...
  server.on("/restart", HTTP_GET, [](AsyncWebServerRequest *request) {
    ...
    SHOW_LED(255, 0, 0, 0);
    _PRINT_DEBUG_("✅   Restarting to refresh...\n");
    vTaskDelay(1000 / portTICK_PERIOD_MS);
    ESP.restart();
  });
  ...
  server.on("/gettimes", HTTP_GET, [](AsyncWebServerRequest *request) {
    ...
    int thr = timeinfo.tm_hour;  // hours:          0–23
    int tmin = timeinfo.tm_min;  // minutes:        0–59
    int tsec = timeinfo.tm_sec;  // seconds:        0–60

    int hour12 = thr % 12;
    if (hour12 == 0) hour12 = 12;  // Convert 0 to 12 for 12-hour format
    snprintf(timeBuffer12, sizeof(timeBuffer12), "%02d:%02d:%02d %s", hour12, tmin, tsec, (thr >= 12) ? "PM" : "AM");
    snprintf(timeBuffer24, sizeof(timeBuffer24), "%02d:%02d:%02d", thr, tmin, tsec);
    ...
    snprintf(jsonResponse, sizeof(jsonResponse),
             ...
             Day_Gregorian, Day_hijri,
             Date_Gregorian, Month_Gregorian,
             Date_hijri, Month_hijri,
             thr, tmin, tsec, tday, tmon, tyear,
  ...
  server.on("/file", HTTP_GET, [](AsyncWebServerRequest *request) {
    AsyncWebServerResponse *response = request->beginResponse(200, "text/html", (const uint8_t *)file_html, file_html_len);
    response->addHeader("Content-Encoding", "gzip");
    request->send(response);
  });
  ...
  server.on("/download", HTTP_GET, [](AsyncWebServerRequest *request) {
    ...
    if (SD_TYPE.exists(path)) {
      request->send(SD_TYPE, path, nullptr, true);
    } else {
      request->send(404, "application/json", "{\"status\":\"error\",\"message\":\"File not found\"}");
    }
  });
...
void playSequence(int vol, int repeatCount) {
  ...
  if (!audio.isRunning() && playSurahSequence) {
    if (remainingRepeats > 0 && currentIndex < repeatQueueSize) {
      ...
      remainingRepeats--;
      currentIndex = 0;
    } else if (!playedKahf && strcmp(Day_Gregorian, "Friday") == 0) {
...
void monitorMMCCard() {
  ...
  bool cardPresent = digitalRead(MMC_DETECT);

  if (cardPresent && !sdInitialized) {
    if (SD_TYPE.begin()) {
      sdInitialized = true;
      _PRINT_DEBUG_("✅   SD card inserted and mounted\n");
      listDir("/", 0, true);
    } else {
      _PRINT_DEBUG_("❌   Failed to mount SD\n");
    }
  } else if (!cardPresent && sdInitialized) {
    sdInitialized = false;
    SD_TYPE.end();  // Properly detach SD
    _PRINT_DEBUG_("⚠️   SD card removed and unmounted\n");
  }
}
